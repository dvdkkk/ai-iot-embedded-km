              ...
              <div className="space-y-3 pt-4">
                  <div className="flex items-center gap-4">
                      ...
                      <div>
                          ...
                          <a href="tel:16619726" className="text-2xl font-black block hover:opacity-80 transition-opacity md:pointer-events-none md:cursor-default">1661-9726</a>
                      </div>
                  </div>
                  <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-white text-purple-800 rounded-full flex items-center justify-center">
          ...
          <Reveal delay={200} className="h-full">
            <div className="bg-white rounded-2xl p-4 md:p-7 shadow-2xl h-full">
              {status === "SUCCESS" ? (
                  ...
                  <div className="space-y-0.5 md:space-y-1">
                      <label className="text-xs font-bold text-gray-700 ml-1">문의내용 (선택)</label>
